...
# def clip_hr_temperatures(src_path, out_path, t_max=60):
#     """Clip physically unrealistic temperature values before downsampling."""
#     with rasterio.open(src_path) as src:
...
def compute_positions(
    ...
    positions = sorted({(r0, c0) for r0, c0, _ in candidates})
